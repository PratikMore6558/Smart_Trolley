...
void loop()
{
  ...
  if (Serial.available())
  {
    ...
    if (count == 12)
    {
      if ((strncmp(input, "163103185149", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "A367B995", 12) == 0) && (a == 0))
      {
        if(p1>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "0B0093B9750F", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "0B0093B9750F", 12) == 0) && (a == 0))
      {
         if(p2>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "0B00C3E56A0F", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "0B00C3E56A0F", 12) == 0) && (a==0))
      {
        if(p3>0)
        {
        lcd.clear();
